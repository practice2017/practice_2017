...
public class CassandraConnection {
    ...
    {
        PreparedStatement prepared = session.prepare("INSERT INTO practice_2017.practicetable (pspaynum, account, errcode, errtext, flags, indate, instatus, parentpayid, payamount, paytype, servcode, servtype, termid, totalpayamount) values (?, ?, ?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?)");
